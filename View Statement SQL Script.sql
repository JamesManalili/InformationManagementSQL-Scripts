...
SELECT *
FROM contributionSale1_VIEW;

-- 2ND VIEW
CREATE VIEW contributionSale2_VIEW AS
SELECT cbs1.custNo, cbs1.custName, cbs1.transNo, cbs1.salesDate, MAX(cbs1.effDate) "LATEST_EFFDATE" , cbs1. prodCode, cbs1. quantity
FROM contributionSale1_VIEW cbs1
GROUP BY cbs1.custNo, cbs1.custName, cbs1.transNo, cbs1.salesDate, cbs1.prodCode, cbs1.quantity;
